...
@section('breadcrump')
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Tambah Kategori Meja</li>
          </ol>
@stop
@section('content')
                    ...
                    <tbody>
                     ...
                     <?php foreach ($jenis as $item):  ?>
                      <tr>
                        ...
                        <td>{{$item->nama}}</td>
                        <td>{{$item->ukuran}}</td>
                        <td><img style="width:20%;height:20%;align:center;"src="{{ url('FotoMeja') }}/{{ $item->foto_meja }}" class="img-responsive"></td>
                        <td>
                            ...
                            <a 
                              ...
                              data-nama = "{{$item->nama}}"
                              data-file_gambar = "{{$item->foto_meja}}"
